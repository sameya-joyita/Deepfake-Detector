  ...
  return (
    <section className="upload-card" aria-labelledby="upload-title">
      ...
      <div className="upload-heading-row">
        <div>
          <h1 id="upload-title">Upload to Examine a video</h1>
          <p>
            Up to 30 candidate frames are sampled across the video. Successful
            face crops are prepared with the locked preprocessing protocol, and
            up to 20 are retained for model inference.
          </p>
        </div>
        <span className="protocol-chip">30 candidates → ≤20 model crops</span>
      </div>
