...
class EvidenceTests(unittest.TestCase):
    ...
    def test_live_record_has_no_invented_combined_score(self):
        ...
        self.assertAlmostEqual(record["scores"]["frequency_only_score"], 0.3)
        self.assertAlmostEqual(
            record["model_comparison"]["frequency"]["benchmark_video_auc"],
            0.6439,
        )
