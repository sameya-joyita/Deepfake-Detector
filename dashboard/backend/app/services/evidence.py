    ...
    base.update(
        {
            "scores": {
                ...
                "frequency_only_score": float(inference.frequency_only_score),
            ...
            "model_comparison": {
                ...
                "frequency": {
                    "video_score": float(inference.frequency_only_score),
                    "predicted_label": predicted_label(
                        inference.frequency_only_score, prediction_threshold
                    ),
                    "benchmark_video_auc": metadata.get("benchmarks", {})
                    .get("frequency_only_baseline", {})
                    .get("video_auc"),
                    "role": "separately trained research baseline",
                },
                "dual": {
